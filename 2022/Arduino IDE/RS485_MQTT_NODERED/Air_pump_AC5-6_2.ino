...
//DI TX2 17, DE D5 , RE D4 , RO RX2 16
//AC5-AC6
...
void setup()
{
  ...
  for (int i = 1; i <= 2; i++) {
    ...
    if (i == 1) {
      ...
      client.publish("esp32/currectNo5", currectString);
      delay(500);
      Serial.print("powerNo3: ");
      Serial.println(powerString);
      client.publish("esp32/powerNo5", powerString);
    } else {
      Serial.print("currect2: ");
      Serial.println(currectString);
      client.publish("esp32/currectNo6", currectString);
      delay(500);
      Serial.print("powerNo2: ");
      Serial.println(powerString);
      client.publish("esp32/powerNo6", powerString);
    }
  }
